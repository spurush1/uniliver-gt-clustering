...
def create_gt_presentation():
    ...
    # Save presentation
    filename = "GT_Clustering_MIT_Academic_Presentation.pptx"
    prs.save(filename)
    print(f"✅ PowerPoint presentation with MIT paper references saved as: {filename}")
    print("📚 Presentation now includes academic foundation from MIT Game Theory research")
    print("🎓 11 slides covering theory, implementation, and business results")
