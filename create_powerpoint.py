...
• Build sustainable competitive advantage"""
    ...
    def add_real_samples_slide():
        ...
        title_frame = title_box.text_frame
        title_para = title_frame.paragraphs[0]
        title_para.text = "🔍 Traditional vs GT Clustering: Actual Data Examples"
        title_para.font.size = Pt(24)
        title_para.font.color.rgb = PRIMARY_COLOR
        title_para.alignment = PP_ALIGN.CENTER
        
        # Traditional clustering sample
        trad_title = slide.shapes.add_textbox(Inches(0.5), Inches(1.5), Inches(4), Inches(0.5))
        trad_title_frame = trad_title.text_frame
        trad_title_para = trad_title_frame.paragraphs[0]
        trad_title_para.text = "❌ Traditional K-Means Clustering:"
        trad_title_para.font.size = Pt(16)
        trad_title_para.font.bold = True
        trad_title_para.font.color.rgb = WARNING_COLOR
        
        trad_sample = slide.shapes.add_textbox(Inches(0.5), Inches(2), Inches(4), Inches(3))
        trad_sample_frame = trad_sample.text_frame
        trad_text = """Cluster 23: "Mixed Components" (43 entities)
...
Solution: Manual sorting required"""
        trad_sample_frame.text = trad_text
        for paragraph in trad_sample_frame.paragraphs:
            paragraph.font.size = Pt(12)
            paragraph.font.color.rgb = WARNING_COLOR
        
        # GT clustering sample
        gt_title = slide.shapes.add_textbox(Inches(5), Inches(1.5), Inches(4), Inches(0.5))
        gt_title_frame = gt_title.text_frame
        gt_title_para = gt_title_frame.paragraphs[0]
        gt_title_para.text = "✅ GT Coalition Formation:"
        gt_title_para.font.size = Pt(16)
        gt_title_para.font.bold = True
        gt_title_para.font.color.rgb = SUCCESS_COLOR
        
        gt_sample = slide.shapes.add_textbox(Inches(5), Inches(2), Inches(4), Inches(3))
        gt_sample_frame = gt_sample.text_frame
        gt_text = """Coalition Alpha: "SS Premium Alliance" (37 entities)
...
Value: Premium pricing ready"""
        gt_sample_frame.text = gt_text
        for paragraph in gt_sample_frame.paragraphs:
            paragraph.font.size = Pt(12)
            paragraph.font.color.rgb = SUCCESS_COLOR
        
        # Business value difference
        value_box = slide.shapes.add_textbox(Inches(1), Inches(5.5), Inches(8), Inches(1.5))
        value_frame = value_box.text_frame
        value_text = """Business Value Difference:
...
• GT Coalition: Strategic alliance ready for premium pricing (5 minutes)"""
        ...
        for paragraph in value_frame.paragraphs:
            paragraph.font.size = Pt(14)
            paragraph.font.bold = True
            paragraph.font.color.rgb = PRIMARY_COLOR
        ...
        value_box.fill.fore_color.rgb = RGBColor(255, 248, 225)
    ...
    # Slide 5: Real-life Cluster Samples Comparison
    add_real_samples_slide()
    
    # Slide 6: Game Theory Solution
    add_content_slide(
    ...
    # Slide 8: Traditional Clustering Sample
    add_content_slide(
    ...
    slide_titles = [
        ...
        "2. MIT Research Foundation - Academic Excellence in Game Theory",
        "3. Sample Dataset Overview - Real Industrial Data Analysis", 
        "4. Business Challenge - Traditional Clustering Fragmentation",
        "5. Real-Life Cluster Samples - Traditional vs GT Comparison",
        "6. Game Theory Solution - Strategic Coalition Formation",
        "7. Performance Comparison - GT Outperforms All Methods",
        "8. Traditional Sample - K-Means 52 Overwhelmed Segments",
        "9. GT Sample - 5 Strategic Business Coalitions",
        "10. Coalition Stability - Why GT Coalitions Remain Stable",
        "11. ROI Projection - $2.5M+ Annual Value",
        "12. Conclusion - Strategic Imperative for Implementation"
    ]
